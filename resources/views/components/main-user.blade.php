    ...
    <div
        ...
        @if ($user->id === Auth::id())
            <a href="{{ route('user.profile', $user->id) }}"
                class="text-lg py-2 px-5 {{ request()->path() === 'user/' . $user->id ? 'dark:bg-neutral-700 bg-gray-300' : '' }} cursor-pointer dark:hover:bg-neutral-600 hover:bg-gray-400 duration-300 rounded-full font-semibold">Profile</a>
            <a href="{{ route('user.questions') }}"
                class="text-lg py-2 px-5 {{ request()->path() === 'user/questions' ? 'dark:bg-neutral-700 bg-gray-300' : '' }} cursor-pointer dark:hover:bg-neutral-600 hover:bg-gray-400 duration-300 rounded-full font-semibold">Questions</a>
            <a href="{{ route('user.answers') }}"
                class="text-lg py-2 px-5 {{ request()->path() === 'user/answers' ? 'dark:bg-neutral-700 bg-gray-300' : '' }} cursor-pointer dark:hover:bg-neutral-600 hover:bg-gray-400 duration-300 rounded-full font-semibold">Answers</a>
