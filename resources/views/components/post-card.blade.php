    ...
    <div class="flex items-center gap-4">
        <div class="voteBox flex items-center gap-2 dark:bg-[#333333] rounded-full bg-gray-300">
            <button id="upvote" data-question-id="{{ $question->id }}" data-type="up"
                class="vote {{ ($userVotes[$question->id] ?? null) === 'up' ? 'text-blue-500 dark:text-yellow-500' : '' }} dark:bg-[#333333] bg-gray-300 w-10 h-10 rounded-full dark:hover:bg-neutral-700 hover:bg-gray-400 flex items-center justify-center duration-300 cursor-pointer">
            ...
            <button id="downvote" data-question-id="{{ $question->id }}" data-type="down"
                class="vote {{ ($userVotes[$question->id] ?? null) === 'down' ? 'text-blue-500 dark:text-yellow-500' : 'GAY' }} dark:bg-[#333333] bg-gray-300 w-10 h-10 rounded-full dark:hover:bg-neutral-700 hover:bg-gray-400 flex items-center justify-center duration-300 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    viewBox="0 0 256 256">
                    <path
