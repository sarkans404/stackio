            ...
            <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-2">
                ...
                <div class="flex items-center justify-end gap-5">
                    <a href="{{ route('login.show') }}"
                        class="text-lg font-medium underline underline-offset-3">Login</a>
                    <button type="submit"
                        class="w-max py-3 px-14 cursor-pointer bg-yellow-600 rounded-lg font-semibold text-2xl">Register</button>
