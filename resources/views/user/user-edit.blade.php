...
@section('content')
    <section class="main-content max-w-150 translate-x-0 mx-auto my-15 duration-300">
        ...
        <form action="" method="post" class="w-full rounded-3xl mb-20">
            @csrf
            <div class="relative w-max h-max mb-8">
                <div class="h-40 w-40 dark:bg-neutral-400 bg-gray-400 rounded-full">
                    {{-- img --}}
                </div>
            ...
            <label for="about" class="text-lg font-semibold mb-1 inline-block">About You</label>
            <textarea name="about" id="about" placeholder="About"
                class="mb-6 border min-h-30 p-4 dark:border-neutral-600 focus:border-neutral-300 dark:focus:border-neutral-500 border-neutral-400 w-full rounded-2xl outline-none"></textarea>

            <label for="about" class="text-lg font-semibold mb-1 inline-block">Email</label>
