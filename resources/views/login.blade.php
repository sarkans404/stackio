            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-2">
                ...
                <div class="flex items-center justify-end gap-5">
                    <a href="{{ route('register.show') }}"
                        class="text-lg font-medium hover:underline underline-offset-3">Resigter</a>
                    <button type="submit"
                        class="w-max py-3 px-14 cursor-pointer bg-blue-500 hover:bg-blue-700 dark:hover:bg-yellow-700 duration-300 dark:bg-yellow-600 rounded-lg font-semibold text-2xl">Login</button>
